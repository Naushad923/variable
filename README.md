...
Variable/
└── 13_08_2026/
    ├── CLI/                  # Variable passed via interactive prompt or CLI flag
    ├── default/              # Variable defined with default value in main.tf
    ├── terradorm_tfvars/     # Variable loaded automatically from terraform.tfvars
    └── var/                  # Variable passed via terraform plan -var command
💡 Practice Examples Explained
1. Default Value (13_08_2026/default/)
Defines a variable with a default value directly inside the main.tf block.

...
1. 🥇 **`-var` and `-var-file`** options specified on the command line.
...
5. 🎖️ **`default`** value specified in the variable declaration block.
...
* ☁️ [Azure CLI](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli) logged in using `az login`
...
## 📜 License
This practice repository is created for educational and training purposes. Happy Terraforming! 🚀✨
